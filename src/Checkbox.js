	...
	render: function(){
		return (
			<div className={znui.react.classname('zr-checkbox', this.props.className)} style={this.props.style}
				...
				{
					this.state.checked ? <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="check-square" className="icon svg-inline--fa fa-check-square fa-w-14 " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
